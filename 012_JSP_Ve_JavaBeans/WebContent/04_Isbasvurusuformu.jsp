...
<tr bgcolor="CCFF66">
    <td  valign=top colspan=2>
        ...
        <font size=2 color="red"><strong>Eclipse IDE</strong></font>  <br>

        <input type="checkbox" name="tecrubealani" value="Struts">JPA
        ...
        <input type="checkbox" name="tecrubealani" value="Servlets">EJB
        <input type="checkbox" name="tecrubealani" value="NetBeans IDE">NetBeans IDE <hr>

        <input type="checkbox" name="tecrubealani" value="MySql">
        <font size=2 color="red"><strong>MySQL Server</strong></font>

        <input type="checkbox" name="tecrubealani" value="Oracle">ORACLE Server
        <input type="checkbox" name="tecrubealani" value="SqlServer">MSSQL Server
    </td>
</tr>
